...
const Nav = () => {
  ...
  return (
    <nav
      className={` text-[#202E55] flex z-50 justify-between items-center px-3 md:px-10 lg:px-10 xl:px-36   ${
        fix
          ? "bg-white shadow-md backdrop-blur-lg bg-opacity-75"
          : "bg-transparent "
      } w-full  fixed top-0`}
    >
      <Link href="/">
        <Image
          src="/icons/mehfil-logo.png"
          width={170}
          height={170}
          alt="logo"
        />
